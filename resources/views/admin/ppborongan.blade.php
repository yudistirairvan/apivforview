...
<div class="card-body">
    <div class="row mb-2">
        ...
        <a href="/admin/pp/borongan/tambah"><button type="button" class="btn btn-block bg-gradient-primary btn-lg">Tambah Data </button></a>
        </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <table id="data" class="table table-bordered table-striped">
                ...
                $pulsa=0;
                ?>
                @foreach($borongan as $borongandata)

                    <tr>
                        <td>{{ $no }}</td>
                        <?php 
                        
                        if  ($borongandata->Via == "Pulsa")
                        { $hasil_pulsa = number_format($borongandata->Jumlah,2,',','.');
                          echo"
                          <td>   </td>
                          ...
                          $hasil_tf = number_format($borongandata->Jumlah,2,',','.');
                          echo"
                          <td>Rp. $hasil_tf </td> 
                          <td>   </td>";
                        }
                        ...
                        <td><a href="/admin/pp/borongan/edit/{{ $borongandata->id }}" data-toggle="tooltip" title="Edit Data" > <i class="far fa-edit"></i></a>
                            <a href="/admin/pp/borongan/delete/{{ $borongandata->id }}"> <i class="far fa-trash-alt" data-toggle="tooltip" title="Hapus"></i></a>
                         </td>
                ...
                if  ($borongandata->Via == "Pulsa")
                {
                  $pulsa=$pulsa+$borongandata->Jumlah;
                  
                }else{
                  $pendapatan=$pendapatan+$borongandata->Jumlah;
                }
