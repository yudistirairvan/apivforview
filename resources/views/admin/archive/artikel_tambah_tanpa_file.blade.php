...
<div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="/admin/artikel/storenofile" role="form" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="card-footer">
                  ...
                  <a href="/admin/artikel/tambah"><button type="button" class="btn btn-primary">Klik disini untuk artikel dengan file</button></a>
                </div>
              </form>
            </div>
</div>
